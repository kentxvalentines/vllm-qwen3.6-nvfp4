...
$BuildArgs = if ($env:HF_TOKEN) { "--build-arg HF_TOKEN=$($env:HF_TOKEN)" } else { "" }
$BuildCommand = "docker build $BuildArgs -f Dockerfile -t vllm-qwen3.6-nvfp4:latest \"$ModelFolder\""
